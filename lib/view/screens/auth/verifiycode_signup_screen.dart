import 'package:e_commerce_application/controller/auth/verifiycode_signup_controller.dart';
...
class VerifiycodeSignupScreen extends StatelessWidget {
  const VerifiycodeSignupScreen({super.key});

  @override
  Widget build(BuildContext context) {
    VerifiycodeSignupControllerImp controller =
        VerifiycodeSignupControllerImp();
    return Scaffold(
      body: Container(
